...
export const ALL_INDIAN_STATES = Object.keys(INDIAN_STATES_AND_DISTRICTS).sort();

export function getDistrictsForState(stateName: string): string[] {
  if (!stateName) return [];
  // Direct lookup
  if (INDIAN_STATES_AND_DISTRICTS[stateName]) {
    return INDIAN_STATES_AND_DISTRICTS[stateName];
  }
  // Case-insensitive lookup
  const matchedKey = Object.keys(INDIAN_STATES_AND_DISTRICTS).find(
